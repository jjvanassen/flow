...
export function simInit(sceneProp){
  ...
  helper.material.color.setHex( 0xA0A0A0);
...
export function simUpdate(agentDat,sceneProp){
  ...
  var turn = deg2rad(sceneProp.Turn/sceneProp.FrameRate);//asuming 60fps
  var zor = sceneProp.ZoR;
  var zoo = sceneProp.ZoR+sceneProp.ZoO;
  var zoa = sceneProp.ZoR+sceneProp.ZoO+sceneProp.ZoA;
  var aSpeed = sceneProp.Speed/sceneProp.FrameRate;
  var errA = sceneProp.Err/sceneProp.FrameRate;
